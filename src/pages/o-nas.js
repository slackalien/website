  ...
  <Layout>
    ...
    <div className="container py-5">
      ...
      <p>
        ...
        še nihče. Smo fantje in dekleta vseh starosti, ki se ločimo od mlačne
        povprečnosti v dolini predvsem po tem, da želimo svojim strahovom
        pogledati naravnost v oči in jih pustiti nekje v preteklosti. Iščemo
        najlepše prostore izven uhojenih poti, kjer se za kratek čas zasidramo
        in hkrati dotaknemo neba. Mlačnost v dolini nas ima za nore in
      ...
      <p>
        ...
        Pripravljeni smo ti posoditi najboljšo opremo v vesolju. Pripravljeni
        smo s tabo plesati in vriskati ob ognju pozno v noč. Vprašanje je: si ti
        pripravljen/a pogledati strahu naravnost v oči?
      </p>
      <a
